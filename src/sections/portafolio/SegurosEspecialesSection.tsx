      ...
      <div className="relative mx-auto max-w-6xl flex flex-col gap-10 px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-lg font-semibold text-slate-50">
                  Recicladores y Asociación de Recicladores
                </h3>
              </div>
            </div>
        ...
        <FadeInWhenVisible className="border-t border-slate-700/70 pt-6">
          ...
          <p className="mt-4 text-center text-xs text-slate-300/75">
            Si perteneces a un colectivo de ciclistas o recicladores (incluida una
            asociación de recicladores), podemos crear un programa especial para
            ustedes.
          </p>
        </FadeInWhenVisible>
      </div>
